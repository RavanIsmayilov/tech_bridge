  ...
  return (
    <div className="bg-[#99D1ED7A] flex justify-between items-center px-14 py-3">
      ...
      <div className="flex items-center space-x-4">
        <span className="font-bold text-[20px] text-[#08244E]">
          Dərs {currentLevel + 1}:
        </span>
        <span className="text-[#08244E] font-medium text-[20px]">
          Drag & Drop
        </span>
      </div>
      ...
      ${
        i === currentLevel
          ? "bg-[#08244E] text-white font-bold p-4"
          : "bg-[#08244E9E]"
      }`}
              onClick={() => goToLevel(i)}
            >
      ...
      <div className="flex items-center gap-[50px]">
        <button className="flex items-center gap-2 bg-[#08244EB2] text-[#FDD446] px-3 py-1 rounded-[3px] font-semibold cursor-pointer">
          Aysel
          <img src={UpArrow} alt="" />
        </button>
