...
const DragDropHeader: React.FC<DragDropHeaderProps> = ({ currentLevel, goToLevel }) => {
	return (
		<>
			...
			<div className="w-full mt-[20px] h-[50px] bg-[#08244E] flex items-center justify-between">
				...
				<img src={StashArrow} alt="logo" className="cursor-pointer hover:-rotate-45 transition-all mr-8" />
			</div>
		</>
	);
};
