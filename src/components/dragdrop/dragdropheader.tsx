    ...
    <>
      <div className="bg-blue-100 flex flex-col sm:flex-row justify-between items-center px-6 py-3">
        ...
        <div className="flex items-center space-x-4 sm:order-2 mt-2 sm:mt-0">
          <span className="font-semibold text-[#08244E]">
            Dərs {currentLevel + 1}:
          </span>
        ...
        <div className="flex space-x-1 items-center gap-1 sm:order-3 mt-2 sm:mt-0">
          {Array(10)
            ...
            .map((_, i) => (
              <button
                key={i}
                className={`flex items-center justify-center text-white w-3 h-3 rounded-full cursor-pointer ${
                  i === currentLevel
                    ? "p-[12px] bg-[#08244E]"
                    : "bg-[#08244E9E]"
                }`}
        ...
        <div className="flex items-center space-x-4 sm:order-4 mt-2 sm:mt-0">
          <span className="bg-[#08244EB2] px-3 py-1 rounded-[7px] text-sm font-semibold text-[#FDD446]">
            Aysel ⬆
          </span>
      ...
      <div className="w-full mt-[20px] h-[50px] bg-[#08244E] flex items-center justify-between">
        ...
        <div className="flex w-[1000px] text-center justify-center">
          <div className="relative">
            ...
            <span className="absolute text-[19px] top-1 left-8 text-white font-bold">
              Təlimatlar
            </span>
          </div>
          <h1 className="text-[19px] font-[600] text-white mx-auto">
            İş sahəsi
          </h1>
        </div>
        ...
        <img
          src={StashArrow}
          alt="logo"
          className="cursor-pointer hover:-rotate-45 transition-all mr-8"
        />
      </div>
    </>
  );
